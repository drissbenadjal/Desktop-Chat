    ...
    return (
        <div className="utilsbar">
            ...
            <div className="utilsbar-action">
                <Link to="/home" className={useLocation().pathname === "/home" || useLocation().pathname === "/" ? "active" : ""}>
                    <p>Friends</p>
                </Link>
                <Link to="/Premium" className={useLocation().pathname === "/premium" ? "active" : ""}>
                    <p>Premium</p>
                </Link>
            </div>
            <div className="utilsbar-friend">
                ...
                <div className='utilsbar-friend__bottom'>
                    <ul>
                        <li className={useLocation().pathname === "/private/1" ? "active-pm" : ""}>
                            <Link to="/private/1">
                        ...
                        <li className={useLocation().pathname === "/private/2" ? "active-pm" : ""}>
                            <Link to="/private/2">
                                <div className='status-container'>
                                    <img src="https://media.valorant-api.com/playercards/aeb4ce01-4781-9330-43cb-b991d1122c99/smallart.png" alt="logo" />
